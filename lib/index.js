...
var GitlabDownload = (function () {
  ...
  _createClass(GitlabDownload, [{
    key: 'download',
    value: function download(remote, branch, dest) {
      var _this = this;

      var downloadOptions = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];
      ...
      return new Promise(function (resolve, reject) {
        ...
        (0, _assert2['default'])(!(0, _underscoreStringIsBlank2['default'])(branch), 'branch is mandatory');
        (0, _assert2['default'])(!(0, _underscoreStringIsBlank2['default'])(dest), 'dest is mandatory');

        var url = _this.gitlabUrl + '/' + remote + '/' + tpl.expand({ private_token: _this.token, ref: branch });
